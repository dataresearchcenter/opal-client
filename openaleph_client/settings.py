...
INVENTORY_TABLE_NAME = os.environ.get("MEMORIOUS_INVENTORY_TABLE_NAME")
INVENTORY_TABLE_NAME = os.environ.get("OPENALEPH_INVENTORY_TABLE_NAME", INVENTORY_TABLE_NAME) 
INVENTORY_TABLE_NAME = os.environ.get("OPAL_INVENTORY_TABLE_NAME", INVENTORY_TABLE_NAME)
INVENTORY_TABLE_NAME = "files"
